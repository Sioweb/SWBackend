...
class SWBackend extends Sioweb {
  ...
  public function sw_initialize() {
    ...
    if($this->BackendUser->showSignetInNavi || ($GLOBALS['TL_CONFIG']['showSignetForLogin'] && TL_SCRIPT == 'contao/index.php'))
      $this->loadSignet();
  ...
  private function mergeSitesAndArticles() {
    ...
    // $GLOBALS['TL_HOOKS']['executePostActions'][] = array('sioweb\contao\extensions\backend\SWAjax.php','executePostActions');
  ...
  protected function fileManagerSettings() {
    ...
    } else $FileManager = $GLOBALS['TL_CONFIG']['siowebFilemanager'];
